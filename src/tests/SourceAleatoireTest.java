 ...
 * SourceAleatoire.
 * Elle vérifie le comportement de la classe SourceAleatoire en générant des
 * symboles aléatoires et en vérifiant la taille de l'information générée ainsi
 * que la cohérence entre deux instances de la classe.
 * 
 */
public class SourceAleatoireTest {
     ...
     * en utilisant le constructeur par défaut et le constructeur avec une graine
     * spécifiée.
     * Il vérifie également si deux instances de SourceAleatoire avec la même graine
