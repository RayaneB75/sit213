...
public class TebFctSnrCodage {
    ...
    public static void main(String[] args) {
        ...
        String csvFileName = "teb_fct_snr_codage.csv";
        System.out.println("Simulation en cours...");
        try (FileWriter csvWriter = new FileWriter(csvFileName)) {
            csvWriter.append("SNRpb");
            csvWriter.append(",");
            csvWriter.append("TEB RZ Codage");
            csvWriter.append(",");
            csvWriter.append("TEB NRZ Codage");
            csvWriter.append(",");
            csvWriter.append("TEB NRZT Codage");
            csvWriter.append("\n");
